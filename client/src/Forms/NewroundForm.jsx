export default function NewroundForm(props) {
  return (
    <form onSubmit={props.handleSubmit} className="flex flex-col flex-nowrap items-center text-lg bg-black">
      <div className='flex items-center bg-green-400  rounded-t-lg border-green-500 mt-10 w-50'>
      ...
      <div className='flex items-center bg-green-400 border-green-500 m-0'>
      ...
      <div className="flex items-center bg-green-400  rounded-b-lg border-green-500 mb-10">
