  ...
  return (
    <form onSubmit={props.handleSubmit}>
      <div className="grid grid-cols-9 grid-rows-2 text-base justify-items-start m-10 p-5 border-4 border-black bg-green-200 rounded-xl">
        ...
        <input className='w-7 border-4 border-black' type='text' value={props?.ten} onChange={e => props.setTen(e.target.value)} />
        <input className='w-7 border-4 border-black' type='text' value={props?.eleven} onChange={e => props.setEleven(e.target.value)} />
        <input className='w-7 border-4 border-black' type='text' value={props?.twelve} onChange={e => props.setTwelve(e.target.value)} />
        <input className='w-7 border-4 border-black' type='text' value={props?.thirteen} onChange={e => props.setThirteen(e.target.value)} />
        <input className='w-7 border-4 border-black' type='text' value={props?.fourteen} onChange={e => props.setFourteen(e.target.value)} />
        <input className='w-7 border-4 border-black' type='text' value={props?.fifteen} onChange={e => props.setFifteen(e.target.value)} />
        <input className='w-7 border-4 border-black' type='text' value={props?.sixteen} onChange={e => props.setSixteen(e.target.value)} />
        <input className='w-7 border-4 border-black' type='text' value={props?.seventeen} onChange={e => props.setSeventeen(e.target.value)} />
        <input className='w-7 border-4 border-black' type='text' value={props?.eighteen} onChange={e => props.setEighteen(e.target.value)} />
      </div>
